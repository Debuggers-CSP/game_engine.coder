...
/* Responsive design */
  ...
  @media (max-width: 768px) {
    ...
    <div class="generator-card">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 20px; grid-auto-rows: 1fr;">
            <!-- Row 1, Column 1: Main Plot Hooks -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">Main Plot Hooks</h3>
                <div id="main-plot-hooks" style="flex: 1;"></div>
            </div>
            
            <!-- Row 1, Column 2: Character Motivations -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">Character Motivations</h3>
                <div id="character-motivations" style="flex: 1;"></div>
            </div>
            
            <!-- Row 1, Column 3: NPCs -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">NPCs</h3>
                <div id="npcs" style="flex: 1;"></div>
            </div>
            
            <!-- Row 2, Column 1: Side Quests -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">Side Quests</h3>
                <div id="side-quests" style="flex: 1;"></div>
            </div>
            
            <!-- Row 2, Column 2: Locations -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">Locations</h3>
                <div id="locations" style="flex: 1;"></div>
            </div>
            
            <!-- Row 2, Column 3: Twists -->
            <div style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 215, 0, 0.2); border-radius: 15px; padding: 20px; display: flex; flex-direction: column;">
                <h3 style="color: #ffd700; text-align: center; margin-bottom: 15px; font-size: 1.2em; padding-bottom: 10px; border-bottom: 2px solid rgba(255, 215, 0, 0.3);">Twists</h3>
