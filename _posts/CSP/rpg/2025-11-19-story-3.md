...
<div class="container">
    <!-- Game Runner Only -->
    <div style="margin: 0; max-width: 100%; padding: 0;">
            <iframe src="{{ site.baseurl }}/rpg/latest?embed=1" title="RPG Runner" style="width:100%; height:90vh; border:0; display:block; background:#0a0a14;" loading="lazy"></iframe>
    </div>
</div>
