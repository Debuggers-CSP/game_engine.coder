...
<div class="generator-card" id="world-map-builder">
  ...
  <style>
    ...
    .wm-palette { display:flex; flex-direction:column; gap:10px; }
    .wm-group-title { color:#cfe3ff; font-size:0.95em; margin:4px 0; padding:4px 6px; border-left:3px solid rgba(255,215,0,0.35); background: rgba(255,215,0,0.06); border-radius:6px; }
    .wm-group-grid { display:grid; grid-template-columns: repeat(3, 1fr); gap:8px; }
