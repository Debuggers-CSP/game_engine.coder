...
/* Responsive design */
  ...
  @media (max-width: 768px) {
    ...
    <div class="generator-card">
        ...
        <h2 class="generator-title">World Map Quest Tracker</h2>
        <p style="color: #c0c0c0; margin-bottom: 25px;">Build your campaign by creating quests for different locations!</p>
        
        <form id="quest-form" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 25px; text-align: left;">
    ...
    <div class="generator-card">
        <div style="max-width: 1600px; margin: 0 auto; padding: 0 30px;">
        <h2 class="generator-title">Story Element Generator</h2>
        <p style="color: #c0c0c0; margin-bottom: 25px;">Get inspired with random story elements for your RPG! Vote on your favorites. Heart for 'Love It' or Skip for 'Skip It'!</p>
        </div>
        
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 0; margin-top: 30px;">
            <!-- Main Plot Hooks -->
            <div style="background: linear-gradient(135deg, rgba(76, 201, 240, 0.15), rgba(0, 0, 0, 0.3)); border: 1px solid rgba(76, 201, 240, 0.4); border-radius: 0; padding: 25px; display: flex; flex-direction: column; min-height: 400px;">
                <h3 style="color: #4cc9f0; text-align: center; margin-bottom: 15px; font-size: 1.3em; padding-bottom: 15px; border-bottom: 2px solid rgba(76, 201, 240, 0.3); text-transform: uppercase; letter-spacing: 1px;">⚔️ Main Plot Hooks</h3>
            ...
            <div style="background: linear-gradient(135deg, rgba(251, 146, 60, 0.15), rgba(0, 0, 0, 0.3)); border: 1px solid rgba(251, 146, 60, 0.4); border-radius: 0; padding: 25px; display: flex; flex-direction: column; min-height: 400px;">
                <h3 style="color: #fb923c; text-align: center; margin-bottom: 15px; font-size: 1.3em; padding-bottom: 15px; border-bottom: 2px solid rgba(251, 146, 60, 0.3); text-transform: uppercase; letter-spacing: 1px;">🗺️ Locations</h3>
