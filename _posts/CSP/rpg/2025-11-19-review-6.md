...
<div class="review-wrap">
    ...
    <div id="review-grid" class="review-grid">
        ...
        <div class="card" id="card-votes">
            ...
            <p class="muted" id="votes-note">Personal Love/Skip choices are not tracked on the server yet. You can still revisit Story to vote.</p>
            <div class="actions">
...
// -------- Character Visual (simple default preview) --------
