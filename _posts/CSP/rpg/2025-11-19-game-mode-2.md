...
<div id="rpg-nav-sidebar" class="rpg-nav-sidebar">
  ...
  <div class="nav-content">
    ...
    <nav class="nav-links">
      ...
      <a href="/rpg/character-creation" class="nav-link locked" data-page="4">
        <span class="nav-number">4</span>
        <span class="nav-text">Character Creation</span>
        <span class="nav-lock">🔒</span>
      </a>
      <a href="/rpg/keybindings" class="nav-link locked" data-page="5">
      ...
      <a href="/rpg/review" class="nav-link locked" data-page="7">
