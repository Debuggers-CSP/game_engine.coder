  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    gameModeCards.forEach(card => {
      card.addEventListener('click', function () {
        ...
        console.log('📱 Game mode saved to localStorage:', mode);
    ...
    continueBtn.addEventListener('click', function () {
      if (selectedMode) {
        ...
        // Save to localStorage as well so story page can access it
        localStorage.setItem('rpgGameMode', selectedMode);
        console.log('📱 Saved to localStorage:', selectedMode);
